...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dout_layer2, grads['W3'], grads['b3'] =affine_backward(dout,layer3_cache)
        dout_layer1, grads['W2'], grads['b2'] =affine_relu_backward(dout_layer2,layer2_cache)
        _, grads['W1'], grads['b1'] =conv_relu_pool_backward(dout_layer1,layer1_cache)
